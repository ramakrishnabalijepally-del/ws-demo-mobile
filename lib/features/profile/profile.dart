/// Profile — the candidate's own record, plus settings and help.
///
/// The profile is the base of the app: the CRS score is calculated from its
/// sections, which the completion checklist walks through.
library;
